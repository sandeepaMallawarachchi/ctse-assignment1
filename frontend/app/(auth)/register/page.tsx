      ...
      <div className="flex w-full max-w-screen overflow-hidden rounded-lg px-20">
        ...
        <div className="w-full lg:w-1/3 bg-white px-4 py-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
            ...
            {errors.general && (
              <p className="text-xs text-[var(--color-primary-btn)]">{errors.general}</p>
            )}

            <button
              type="submit"
              disabled={loading}
              className="mt-1 h-[56px] w-full rounded bg-[var(--color-primary-btn)] text-sm font-medium text-white transition-colors hover:bg-[var(--color-primary-btn-hover)] disabled:opacity-60"
            >
