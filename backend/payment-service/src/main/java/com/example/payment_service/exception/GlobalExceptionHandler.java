...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleValidation(
        ...
        return response(HttpStatus.BAD_REQUEST, "Validation failed", request.getRequestURI(), errors);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleUnauthorized(UnauthorizedException ex, HttpServletRequest request) {
        return response(HttpStatus.UNAUTHORIZED, ex.getMessage(), request.getRequestURI(), null);
    }
    ...
    private <T> ResponseEntity<ApiResponse<T>> response(HttpStatus status, String message, String path, T data) {
